...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .coop-banner { background: var(--black); border-radius: 10px; padding: 22px 28px; margin-bottom: 22px; flex-shrink: 0; }
  .coop-banner-tag { font-size: 9px; letter-spacing: 2.5px; text-transform: uppercase; color: var(--yellow); font-weight: 600; margin-bottom: 6px; }
  .coop-banner-title { font-family: 'Montserrat', sans-serif; font-size: 22px; font-weight: 700; color: white; margin-bottom: 6px; }
  .coop-banner-sub { font-size: 11px; color: rgba(255,255,255,0.6); line-height: 1.6; max-width: 460px; }
  .coop-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 20px; }
  .coop-card { border: 1px solid var(--border); border-radius: 8px; padding: 14px 16px; background: white; }
  .coop-card.highlight { border-color: var(--yellow); background: var(--yellow-light); }
  .coop-card-header { display: flex; align-items: center; gap: 9px; margin-bottom: 8px; }
  .coop-card-icon { width: 28px; height: 28px; background: var(--black); border-radius: 6px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; color: white; }
  .coop-card.highlight .coop-card-icon { background: var(--yellow); color: var(--black); }
  .coop-card-title { font-family: 'Montserrat', sans-serif; font-size: 11.5px; font-weight: 700; color: var(--black); }
  .coop-card-desc { font-size: 10.5px; color: var(--muted); line-height: 1.6; }
  .included-wrap { background: var(--bg); border-radius: 8px; padding: 14px 18px; }
  .included-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 7px 24px; }
  .inc-item { display: flex; align-items: center; gap: 7px; font-size: 10.5px; color: var(--gray); }
  .inc-dot { width: 16px; height: 16px; background: var(--yellow); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
  .inc-dot svg { width: 9px; height: 9px; color: var(--black); }
</style>
</head>
<body>
<!-- PAGE 1: COVER -->
...
<div class="page">
  ...
  <div class="page-footer">
    ...
    <span>Strana 2 / 4</span>
  </div>
</div>
<!-- PAGE 3: NÁVRH SPOLUPRÁCE -->
<div class="page">
  <div class="inner">
    <div class="page-header">
      <div class="ph-left">
      ...
      <div class="ph-right">
        <div class="ph-title">Návrh spolupráce</div>
        <div class="ph-meta">{{nabidka_kod}} · {{datum_vystaveni}}</div>
      </div>
    </div>

    <div class="coop-banner">
      <div class="coop-banner-tag">Návrh spolupráce</div>
      <div class="coop-banner-title">Více než jen instalace.</div>
      <div class="coop-banner-sub">Chceme být vaším dlouhodobým partnerem — od prvního návrhu až po servis a modernizaci. Přinášíme vám komplexní řešení s jasně definovanými podmínkami spolupráce.</div>
    </div>

    <div class="section-label">Podmínky spolupráce</div>
    <div class="coop-grid">
      <div class="coop-card">
        <div class="coop-card-header">
          <div class="coop-card-icon">
          ...
          <div class="coop-card-title">Realizace</div>
        </div>
        <div class="coop-card-desc">Kompletní instalace certifikovanými techniky včetně dopravy, uvedení do provozu a odevzdání dokumentace. Termín realizace upřesníme po uzavření smlouvy.</div>
      </div>
      <div class="coop-card highlight">
        <div class="coop-card-header">
          <div class="coop-card-icon">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          </div>
          <div class="coop-card-title">Záruka</div>
        </div>
        <div class="coop-card-desc">Na provedené práce poskytujeme záruku 24 měsíců. Na dodané technologie platí záruční podmínky výrobce. Záruční i pozáruční servis zajišťujeme vlastními techniky.</div>
      </div>
      <div class="coop-card">
        <div class="coop-card-header">
          <div class="coop-card-icon">
          ...
          <div class="coop-card-title">Servisní péče</div>
        </div>
        <div class="coop-card-desc">Po dokončení realizace nabídneme servisní smlouvu s pravidelnými prohlídkami a přednostní reakcí při poruše. Servisní plán přizpůsobíme vašim potřebám.</div>
      </div>
      <div class="coop-card">
        <div class="coop-card-header">
          <div class="coop-card-icon">
          ...
          <div class="coop-card-title">Platební podmínky</div>
        </div>
        <div class="coop-card-desc">Standardní podmínky: záloha 50 % před zahájením prací, doplatek do 14 dní od předání díla. Možnost jiného způsobu platby nebo financování po vzájemné dohodě.</div>
      </div>
    </div>

    <div class="section-label">Co je zahrnuto v ceně</div>
    <div class="included-wrap">
      <div class="included-grid">
        <div class="inc-item"><div class="inc-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>Projekt a technická dokumentace</div>
        <div class="inc-item"><div class="inc-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>Záruční list a revizní protokol</div>
        <div class="inc-item"><div class="inc-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>Doprava materiálu a technici</div>
        <div class="inc-item"><div class="inc-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>Zaškolení obsluhy a doporučení provozu</div>
        <div class="inc-item"><div class="inc-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>Uvedení do provozu a nastavení</div>
        <div class="inc-item"><div class="inc-dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>Telefonická podpora po dobu záruky</div>
      </div>
    </div>
