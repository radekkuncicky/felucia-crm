...
import { getPerms, type PermissionKey } from '@/lib/permissions'
...
interface CardDef {
  ...
  /** oprávnění potřebné k zobrazení karty (bez = pro každého) */
  perm?: PermissionKey
}
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        href: '/settings/email',
        perm: 'nastaveniOrg',
        label: 'Odesílání e-mailů',
        description: 'Firemní SMTP účet pro e-maily klientům',
