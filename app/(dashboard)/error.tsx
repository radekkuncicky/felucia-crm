  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-6 max-w-md">
        Při načítání stránky došlo k chybě. Zkuste to znovu — pokud problém přetrvává, kontaktujte podporu.
      </p>
      {error.digest && (
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/dashboard"
          className="text-sm font-medium text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white px-4 py-2 rounded-lg border border-gray-200 dark:border-slate-700 transition-colors"
        >
          Zpět na nástěnku
        </Link>
      </div>
